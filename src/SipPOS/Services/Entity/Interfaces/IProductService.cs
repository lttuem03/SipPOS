...
public interface IProductService
{
    ...
    Task<Pagination<ProductDto>> GetWithPagination(ProductFilterDto productFilterDto, SortDto sortDto, int perPage, int page);
    ...
    Task<ProductDto?> UpdateById(ProductDto productDto);
    ...
    Task<List<ProductDto>> DeleteByIds(List<long> ids);
}
