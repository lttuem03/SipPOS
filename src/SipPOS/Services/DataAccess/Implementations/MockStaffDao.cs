...
class MockStaffDao : IStaffDao
{
    ...
    public Task<(long totalRowsMatched, List<StaffDto>? staffDtos)> GetWithPaginationAsync(long storeId, long page, long rowsPerPage, string keyword, string? sortBy, string? sortDirection, List<string>? filterByPositionPrefixes = null) => throw new NotImplementedException();
