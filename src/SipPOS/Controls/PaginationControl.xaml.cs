...
namespace SipPOS.Controls
{
    public sealed partial class PaginationControl : UserControl
    {
        ...
        private List<int> _PerPages

        {
            get => PerPages.Split(',').Select(int.Parse).ToList();
        }
        ...
        private void UpdateButtons()
        {
            ...
            long maxRecordShow = CurrentPage * PerPage > TotalRecord ? TotalRecord : CurrentPage * PerPage;
