...
/// <summary>
/// Represents a special offer data transfer object.
/// </summary>
public class SpecialOfferDto : BaseEntityDto
{
    ...
    /// <summary>
    /// Gets or sets a value indicating whether the special offer is selected.
    /// </summary>
    public bool IsSelected { get; set; } = false;

    /// <summary>
    /// Gets or sets the discount amount as a string.
    /// </summary>
